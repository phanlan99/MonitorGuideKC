...
import { Monitor, ChevronDown, Activity, History, AlertTriangle } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="flex space-x-6">
            {/* Dropdown cho GuideKC #1 */}
            <NavDropdown title="GuideKC #1" baseUrl="/kc1" />
            
            {/* Dropdown cho GuideKC #2 */}
...
function NavDropdown({ title, baseUrl }: { title: string; baseUrl: string }) {
  return (
    <div className="relative group py-4"> {/* py-4 để tạo vùng đệm khi hover chuột */}
      ...
      {/* Menu con - Chỉ hiện khi hover vào group cha */}
      <div className="absolute left-0 mt-2 w-56 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform translate-y-2 group-hover:translate-y-0 bg-slate-800 border border-slate-700 rounded-lg shadow-xl overflow-hidden z-50">
