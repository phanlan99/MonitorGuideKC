...
// 1. IMPORT COMPONENT BẢNG THỐNG KÊ CHI TIẾT
import AnalysisMonthlyStats2 from './AnalysisMonthlyStats2'; 
...
export default function AnalysisChartMonthly() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {/* 2. GỌI BẢNG THỐNG KÊ CHI TIẾT THÁNG KÈM PHÂN TRANG Ở ĐÂY */}
      <AnalysisMonthlyStats2 selectedYear={selectedYear} />
