...
import { getKC1AnalysisWeekly } from '@/services/kc1-analysis-services'; // Đã đổi
...
export default function AnalysisChartWeekly1() { // Đã đổi tên
  ...
  useEffect(() => {
    const loadData = async () => {
      setLoading(true);
      try {
        const result = await getKC1AnalysisWeekly(selectedYear); // Đã đổi hàm
        setData(result);
