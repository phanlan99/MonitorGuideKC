// src/components/AnalysisChart7ngay.tsx
'use client';

import { useEffect, useState } from 'react';
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer } from 'recharts';
import { getWeeklyAnalysis, DailyAnalysisData } from '@/services/kc2-analysis'; // Import service giữ nguyên
import { Loader2 } from 'lucide-react';

export default function AnalysisChart7ngay() {
