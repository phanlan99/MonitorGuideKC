...
export async function getKC2MonthlyDetailedStats(year: number): Promise<MonthlyStatsResponse> {
  try {
    // 1. Khởi tạo mảng 12 tháng (từ tháng 12 lùi về tháng 1)
    ...
    console.error('Lỗi tính toán Monthly Stats KC2:', error);
