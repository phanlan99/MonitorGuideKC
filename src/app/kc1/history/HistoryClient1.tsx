...
import { searchKC1History, HistoryItemKC1, HistoryFilterKC1 } from '@/services/kc1-service';

export default function HistoryClient1() {
  ...
  const [filters, setFilters] = useState<HistoryFilterKC1>({
  ...
  const [data, setData] = useState<HistoryItemKC1[]>([]);
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    setHasSearched(true);
    try {
      const results = await searchKC1History(filters);
      setData(results);
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden min-h-[400px]">
        ...
        {!hasSearched ? (
          ...
          <>
            {/* THÊM MỚI: THÀNH PHẦN THỐNG KÊ (SUMMARY CARDS) */}
