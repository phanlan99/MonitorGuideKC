...
import AnalysisClient from "./AnalysisClient"; // Import Client Component vừa tạo
import { PieChart } from "lucide-react";

export default async function KC2AnalysisPage() {
    ...
    return (
      <main className="min-h-screen bg-slate-50 flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center p-4">
          <LoginForm title="Trang Phân tích GuideKC #2 yêu cầu đăng nhập" />
        </div>
      </main>
    );
  }
  ...
  return (
    <main className="min-h-screen bg-slate-50 pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Gọi Component quản lý giao diện Tab */}
        <AnalysisClient />
